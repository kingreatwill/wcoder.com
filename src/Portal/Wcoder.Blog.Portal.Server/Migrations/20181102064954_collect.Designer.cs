...
namespace Wcoder.Blog.Portal.Server.Migrations
{
    ...
    [Migration("20181102064954_collect")]
            ...
            modelBuilder.Entity("Wcoder.Blog.Protocol.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Created = new DateTime(2018, 11, 2, 6, 49, 54, 678, DateTimeKind.Utc), CreatedBy = 0L, Deleted = false, DeletedBy = 0L, LogoId = "", LogoUri = "", Name = "wcoder.com", Updated = new DateTime(2018, 11, 2, 6, 49, 54, 678, DateTimeKind.Utc), UpdatedBy = 0L }
                    );
                });
